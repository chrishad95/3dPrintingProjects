...
flange_height = 8.0;        // Total height of the flange/cap outside the pipe (mm)
...
// --- Calculated Values ---
dome_height = flange_height - rim_height; // Height of the spherical dome (6.0 mm)
plug_od = pipe_id - clearance; // Outer diameter of the plug section
plug_height = total_height - flange_height; // Height of the insert section (17.0 mm)
